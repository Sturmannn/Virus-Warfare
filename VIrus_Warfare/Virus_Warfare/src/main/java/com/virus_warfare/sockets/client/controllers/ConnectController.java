package com.virus_warfare.sockets.client.controllers;

import com.virus_warfare.sockets.client.models.*;
...
public class ConnectController implements ServerResponseListener {
    ...
    private void openGameWindow(Response response) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/virus_warfare/views/sockets/game.fxml"));
