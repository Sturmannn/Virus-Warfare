package com.virus_warfare.server.models;

import com.virus_warfare.client.models.Player;
...
public class Game {
    ...
    private final List<ServerSocketWrapper> clientSockets;
    ...
    private void sendGameOverMessage() {
        ...
        Response response = new Response(winner, grid);
        notifyAllPlayers(response);
    }
